...
public class ReportGenerator {
    ...
    public static void main(String[]args){
        String path="I:\\diplomado\\modulo4\\examenAll\\automationII\\build\\reports\\cucumber\\";
        ...
        Configuration configuration =  new Configuration(reportOutPut,"UCB Diplomado prueba final");
